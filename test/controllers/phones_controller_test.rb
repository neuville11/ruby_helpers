...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { id_contact: @phone.id_contact, phone_number: @phone.phone_number } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { id_contact: @phone.id_contact, phone_number: @phone.phone_number } }
